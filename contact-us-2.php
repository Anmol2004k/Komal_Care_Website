...
">
	...
	<!-- CANONICAL URL -->
	<link rel="canonical" href="https://clinicmaster.dexignzone.com/xhtml/contact-us-2.php">
...
<!-- Sidebar cart -->
	...
	<main class="page-content">
		...
		<div class="dz-bnr-inr style-1 overlay-black-middle dz-bnr-inr-md dz-bnr-detail" style="background-image:url(images/banner/bnr1.webp);">
			<div class="container">
				<div class="dz-bnr-inr-entry">
					<div class="row g-4 align-items-end">
						<div class="col-xl-7 col-lg-6 pe-xl-5">
							<h1 class="wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="0.8s">Contact Us for Your dermatology Experience</h1>
							<div class="dz-media rounded-lg m-t20 wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="0.8s">
								<img src="images/services/bnr1.webp" alt="">
							</div>
						</div>
						<div class="col-xl-5 col-lg-6 wow fadeInUp" data-wow-delay="0.6s" data-wow-duration="0.8s">
							<div class="form-wrapper style-1 bg-white">
								<div class="form-body">
									<div class="section-head style-1 mb-3">
										<h2 class="title fw-semibold m-b0">Get in Touch</h2>
										<p class="m-b0 text-body">You Can React Us Anytime</p>
									</div>
									<form action="https://clinicmaster.dexignzone.com/skincare/xhtml/script/contact_smtp.php" class="dzForm" method="POST">
										<input type="hidden" class="form-control" name="dzToDo" value="Contact">
										<input type="hidden" class="form-control" name="reCaptchaEnable" value="0">
										<div class="dzFormMsg"></div>
										<div class="row">
											<div class="col-sm-12 m-b20">
												<div class="floating-underline underline-1 input-icon-left">
													<span class="input-group-text text-primary"><i class="feather icon-user"></i></span>
													<input name="dzName" type="text" class="form-control" placeholder="Your Name">
												</div>
											</div>
											<div class="col-sm-12 m-b20">
												<div class="floating-underline underline-1 input-icon-left">
													<span class="input-group-text text-primary"><i class="feather icon-mail"></i></span>
													<input name="dzEmail" type="email" class="form-control" placeholder="Your Email Address">
												</div>
											</div>
											<div class="col-sm-12 m-b20">
												<div class="floating-underline underline-1 input-icon-left">
													<span class="input-group-text text-primary"><i class="feather icon-phone"></i></span>
													<input name="dzPhoneNumber" type="tel" class="form-control dz-number" placeholder="Phone Number">
												</div>
											</div>
											<div class="col-sm-12 m-b20">
												<div class="floating-underline underline-1">
													<textarea name="dzMessage" class="form-control" rows="5" placeholder="Write Massage"></textarea>
												</div>
											</div>
											<div class="col-sm-12 m-t10">
												<button type="submit" name="submit" value="submit" class="btn btn-lg btn-primary w-100">
													Send Message 
												</button>
											</div>
										</div>
		...
		<section class="content-inner-1 bg-light">
			<div class="container">
				<div class="row">
					<div class="col-lg-3 col-sm-6 m-b30 wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="0.8s">
						<div class="icon-bx-wraper style-2 bg-white box-hover">
					...
					<div class="col-lg-3 col-sm-6 m-b30 wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="0.8s">
						<div class="icon-bx-wraper style-2 bg-white box-hover">
							<div class="icon-bx bg-secondary">
								<span class="icon-cell">
					...
					<div class="col-lg-3 col-sm-6 m-b30 wow fadeInUp" data-wow-delay="0.6s" data-wow-duration="0.8s">
						<div class="icon-bx-wraper style-2 bg-white box-hover active">
							<div class="icon-bx bg-secondary">
								<span class="icon-cell">
					...
					<div class="col-lg-3 col-sm-6 m-b30 wow fadeInUp" data-wow-delay="0.8s" data-wow-duration="0.8s">
						<div class="icon-bx-wraper style-2 bg-white box-hover">
							<div class="icon-bx bg-secondary">
								<span class="icon-cell">
		...
		<div class="bg-light content-inner-2">
			<div class="container">
				<div class="map-wrapper style-4 wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="0.8s">
					<iframe class="w-100 h-100" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4176.894092633746!2d-0.15502509846427073!3d51.502279254634836!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47d8a00baf21de75%3A0x52963a5addd52a99!2sLondon%2C%20UK!5e0!3m2!1sen!2sin!4v1757506574164!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
				</div>
			</div>
		</div>
		...
		<section class="content-inner bg-light">
			<div class="container">
				<div class="section-head style-3 text-center wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="0.8s">
					<h2 class="title m-b10">All Locations</h2>
				</div>
				<div class="row">
					<div class="col-xl-3 col-md-6 m-b30 wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="0.8s">
						<div class="dz-img-box style-2">
							<div class="dz-head">
								<h3 class="title m-b10"><img src="images/country/united_states.webp" alt=""> United State</h3>
							</div>
							<div class="dz-media">
								<img src="images/map/map1.webp" alt="">
							</div>
							<div class="dz-content">	
								<p class="m-b10">123 Health Way, Suite 456 Goodland, 78910 United States</p>
								<a href="tel:+0123-456-7890" class="text-body">+0 123-456-7890</a> 
							</div>
							<div class="dz-footer">
								<a href="https://www.google.com/maps/" target="_blank" class="icon-link-hover-end">Get Directions <i class="feather icon-arrow-up-right"></i></a>
							</div>
						</div>
					</div>
					<div class="col-xl-3 col-md-6 m-b30 wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="0.8s">
						<div class="dz-img-box style-2">
							<div class="dz-head">
								<h3 class="title m-b10"><img src="images/country/canada.webp" alt=""> Canada</h3>
							</div>
							<div class="dz-media">
								<img src="images/map/map2.webp" alt="">
							</div>
							<div class="dz-content">	
								<p class="m-b10">123 Health Way, Suite 456 Goodland, 78910 United States</p>
								<a href="tel:+0123-456-7890" class="text-body">+0 123-456-7890</a> 
