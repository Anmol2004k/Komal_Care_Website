...
<!-- Mirrored from clinicmaster.dexignzone.com/skincare/xhtml/shop.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 21 Feb 2026 08:01:23 GMT -->
<head>
...
">
	...
	<!-- CANONICAL URL -->
	<link rel="canonical" href="https://clinicmaster.dexignzone.com/xhtml/shop.php">
				...
				<div class="row m-b30 m-md-b0">
					...
					<div class="col-xl-3 col-sm-6 m-b30 wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="0.8s">
						<div class="shop-card">
							...
							<div class="dz-content">
								<div class="inner-content">
									<h3 class="title"><a href="shop-details.php">Body Serum</a></h3>
									<span class="price">$89.00 <del>$119.00</del></span>
								</div>
								<a href="shop-details.php" class="btn btn-square btn-lg btn-white btn-rounded shop-share-btn">
									<i class="feather icon-arrow-up-right"></i>
					...
					<div class="col-xl-3 col-sm-6 m-b30 wow fadeInUp" data-wow-delay="0.6s" data-wow-duration="0.8s">
						<div class="shop-card">
							...
							<div class="dz-content">
								<div class="inner-content">
									<h3 class="title"><a href="shop-details.php">Body Polish</a></h3>
									<span class="price">$89.00 <del>$119.00</del></span>
								</div>
								<a href="shop-details.php" class="btn btn-square btn-lg btn-white btn-rounded shop-share-btn">
									<i class="feather icon-arrow-up-right"></i>
					...
					<div class="col-xl-3 col-sm-6 m-b30 wow fadeInUp" data-wow-delay="1.0s" data-wow-duration="0.8s">
						<div class="shop-card">
							...
							<div class="dz-content">
								<div class="inner-content">
									<h3 class="title"><a href="shop-details.php">Body Wash</a></h3>
									<span class="price">$89.00 <del>$119.00</del></span>
								</div>
								<a href="shop-details.php" class="btn btn-square btn-lg btn-white btn-rounded shop-share-btn">
									<i class="feather icon-arrow-up-right"></i>
					...
					<div class="col-xl-3 col-sm-6 m-b30 wow fadeInUp" data-wow-delay="1.2s" data-wow-duration="0.8s">
						<div class="shop-card">
							...
							<div class="dz-content">
								<div class="inner-content">
									<h3 class="title"><a href="shop-details.php">Body Oil</a></h3>
									<span class="price">$89.00 <del>$119.00</del></span>
								</div>
								<a href="shop-details.php" class="btn btn-square btn-lg btn-white btn-rounded shop-share-btn">
									<i class="feather icon-arrow-up-right"></i>
					...
					<div class="col-xl-3 col-sm-6 m-b30 wow fadeInUp" data-wow-delay="1.4s" data-wow-duration="0.8s">
						<div class="shop-card">
							...
							<div class="dz-content">
								<div class="inner-content">
									<h3 class="title"><a href="shop-details.php">Body Cream</a></h3>
									<span class="price">$89.00 <del>$119.00</del></span>
								</div>
								<a href="shop-details.php" class="btn btn-square btn-lg btn-white btn-rounded shop-share-btn">
									<i class="feather icon-arrow-up-right"></i>
					...
					<div class="col-xl-3 col-sm-6 m-b30 wow fadeInUp" data-wow-delay="1.8s" data-wow-duration="0.8s">
						<div class="shop-card">
							...
							<div class="dz-content">
								<div class="inner-content">
									<h3 class="title"><a href="shop-details.php">Repairing Body Gel</a></h3>
									<span class="price">$89.00 <del>$119.00</del></span>
								</div>
								<a href="shop-details.php" class="btn btn-square btn-lg btn-white btn-rounded shop-share-btn">
									<i class="feather icon-arrow-up-right"></i>
					...
					<div class="col-xl-3 col-sm-6 m-b30 wow fadeInUp" data-wow-delay="2.2s" data-wow-duration="0.8s">
						<div class="shop-card">
							...
							<div class="dz-content">
								<div class="inner-content">
									<h3 class="title"><a href="shop-details.php">Body Scrub</a></h3>
									<span class="price">$89.00 <del>$119.00</del></span>
								</div>
								<a href="shop-details.php" class="btn btn-square btn-lg btn-white btn-rounded shop-share-btn">
									<i class="feather icon-arrow-up-right"></i>
					...
					<div class="col-xl-3 col-sm-6 m-b30 wow fadeInUp" data-wow-delay="2.4s" data-wow-duration="0.8s">
						<div class="shop-card">
							...
							<div class="dz-content">
								<div class="inner-content">
									<h3 class="title"><a href="shop-details.php">Body Mist</a></h3>
									<span class="price">$89.00 <del>$119.00</del></span>
								</div>
								<a href="shop-details.php" class="btn btn-square btn-lg btn-white btn-rounded shop-share-btn">
									<i class="feather icon-arrow-up-right"></i>
					...
					<div class="row align-items-center">
						<div class="col-lg-4 col-md-5 text-center text-md-start wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="0.8s">
							<div class="footer-logo logo-white">
								<a href="index.php"><img src="images/Komal_care-logo-dark.png" alt=""></a> 
							</div>
						</div>
...
<!-- Mirrored from clinicmaster.dexignzone.com/skincare/xhtml/shop.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 21 Feb 2026 08:01:24 GMT -->
</html>
