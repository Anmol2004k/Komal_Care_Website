...
<!-- Mirrored from clinicmaster.dexignzone.com/skincare/xhtml/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 21 Feb 2026 08:00:41 GMT -->
				...
				<div class="main-bar clearfix">
					<div class="container-fluid clearfix inner-bar">
						...
						<div class="extra-nav-left">
							<button type="button" class="toggler1" data-bs-toggle="offcanvas"
	...
	<li class="sub-menu-down">
		...
		<ul class="sub-menu">						
			...
			<li><a href="blog-details.php">Blog Details</a></li>
								...
								<li class="sub-menu-down">
									<a href="javascript:void(0);"><span>Contact Us</span> <i
											class="fas fa-chevron-down tabindex"></i></a>
									<ul class="sub-menu">
			...
			<div class="offcanvas dz-offcanvas offcanvas offcanvas-end" tabindex="-1" id="headerSidebar">
				<button type="button" class="btn-close m-t10 m-l10" data-bs-dismiss="offcanvas"
				...
				<div class="offcanvas-body">
					...
					<div class="widget">
						...
						<ul class="list-check">
							...
							<li><a href="mailto:email@domain.com" class="text-body">email@domain.com</a></li>
							<li><a href="tel:+11234567890" class="text-body">+1 123 456 7890</a></li>
						</ul>
					</div>
					...
					<div class="widget">
						...
						<form class="dzSubscribe style-2"
							action="https://clinicmaster.dexignzone.com/skincare/xhtml/script/mailchimp.php"
							method="post">
								...
								<div class="input-group mb-0">
									...
									<div class="input-group-addon">
										<button name="submit" value="Submit" type="submit"
											class="btn text-primary btn-transparent p-2">
			...
			<!-- Sidebar cart -->
			<div class="offcanvas dz-offcanvas offcanvas offcanvas-end" tabindex="-1" id="sidebarCart">
				<button type="button" class="btn-close m-t10 m-l10" data-bs-dismiss="offcanvas"
					aria-label="Close"></button>
				<div class="offcanvas-body">
					<div class="sidebar-cart-wrapper">
						<h2 class="sidebar-title">Shopping Cart <span
								class="badge badge-primary badge-circle px-0">3</span></h2>
						<div class="shop-sidebar-cart">
							...
							<div class="mt-auto text-center">
								<a href="https://clinicmaster.dexignzone.com/xhtml/medical/error-404.php"
									class="btn btn-primary btn-hover1 mx-1">Checkout</a>
								<a href="https://clinicmaster.dexignzone.com/xhtml/medical/error-404.php"
									class="btn btn-secondary btn-hover1 mx-1">View Cart</a>
							</div>
						</div>
					</div>
				</div>
		...
		<main class="page-content">
			...
			<div class="hero-banner style-1">
				<div class="container">
					<div class="inner-wrapper">
						<div class="row align-items-center h-100">
								...
								<div class="hero-content">
									...
									<div class="d-flex">
										...
										<div class="avatar-group m-l50 wow fadeInUp" data-wow-delay="0.8s"
											...
											<a href="about-us.php"
												class="avatar btn btn-square btn-lg btn-white btn-shadow btn-rounded">
												<svg width="24" height="24" viewBox="0 0 24 24" fill="none"
													xmlns="http://www.w3.org/2000/svg">
													<path d="M7 17L17 7" stroke="var(--bs-secondary)" stroke-width="1.5"
														stroke-linecap="round" stroke-linejoin="round"></path>
													<path d="M7 7H17V17" stroke="var(--bs-secondary)" stroke-width="1.5"
														stroke-linecap="round" stroke-linejoin="round"></path>
												</svg>
											</a>
										</div>
							...
							<div class="col-md-6 align-self-end wow fadeInRight" data-wow-delay="0.8s"
								data-wow-duration="0.8s">
						...
						<div class="item1">
							<div class="widget-rating1">
								...
								<span class="rating text-primary m-r5">(4.8)</span>
						...
						<div class="item3 move-3" data-bottom-top="transform: translateY(-50px)"
							data-top-bottom="transform: translateY(50px)">
							<img src="images/hero-banner/img3.jpg" alt="">
						</div>
						<div class="item4" data-bottom-top="transform: translateY(-50px)"
							data-top-bottom="transform: translateY(50px)">
							<img src="images/hero-banner/img4.jpg" alt="">
						</div>

						<svg class="shape1" viewBox="0 0 61 61" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path
								d="M30.5 0L34.4251 26.5749L61 30.5L34.4251 34.4251L30.5 61L26.5749 34.4251L0 30.5L26.5749 26.5749L30.5 0Z"
								fill="var(--bs-primary)" />
						</svg>
						<svg class="shape2" viewBox="0 0 61 61" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path
								d="M30.5 0L34.4251 26.5749L61 30.5L34.4251 34.4251L30.5 61L26.5749 34.4251L0 30.5L26.5749 26.5749L30.5 0Z"
								fill="var(--bs-primary)" />
						</svg>
				...
				<div class="vertical-info left">
					...
					<a href="javascript:void(0);" class="btn btn-white btn-sm px-2 py-3 btn-shadow rounded">LET'S
						TALK</a>
				</div>
			...
			<section class="content-inner bg-light">
				<div class="container">
					<div class="row content-wrapper style-1">
						<div class="col-xl-5 col-lg-6 m-b15">
							<div class="content-media" data-bottom-top="transform: translateY(-30px)"
						...
						<div class="col-xl-7 col-lg-6 m-b30 position-relative">
							<div class="info-content">
								...
								<div class="d-flex align-items-center m-b15 wow fadeInUp" data-wow-delay="0.4s"
									data-wow-duration="0.8s">
									<div class="info-widget style-1 m-r20 bg-transparent border border-secondary">
										<div class="avatar-group">
											<img class="avatar rounded-circle avatar-md border border-white border-2"
												src="images/avatar/small/avatar1.webp" alt="">
											<img class="avatar rounded-circle avatar-md border border-white border-2"
												src="images/avatar/small/avatar2.webp" alt="">
											<img class="avatar rounded-circle avatar-md border border-white border-2"
								...
								<div class="bottom-media" data-bottom-top="transform: translateY(-30px)"
									data-top-bottom="transform: translateY(30px)">
									<img src="images/about/img2.webp" class="item1" alt="">
									<img src="images/about/img3.webp" class="item2" alt="">
								</div>
							</div>
						</div>
					</div>
			...
			<section class="content-inner-2 bg-light">
				<div class="container">
					<div class="section-head style-3 m-b30 text-center wow fadeInUp" data-wow-delay="0.2s"
						data-wow-duration="0.8s">
						<h2 class="title">Transform Your Skin with Our <br> Advanced Dermatology Treatments</h2>
						<p class="mw-100">Experience a transformative journey that sculpts your physique and unlocks
							your full potential.</p>
					</div>
					<div class="dz-flex-wrapper m-b30 swiper dz-flex-swiper wow fadeInUp" data-wow-delay="0.4s"
						data-wow-duration="0.8s">
						<div class="swiper-wrapper">
							<div class="dz-flex-item swiper-slide active">
								<div class="dz-flex-head"
									style="background-image: url(images/services/middle/img1.webp);">
									...
									<div class="dz-flex-inner">
										...
										<div class="dz-info">
											<div class="dz-info-top">
												<h3 class="dz-title">Cosmetic Dermatology</h3>
												<p class="text">It is a long established fact that a reader will be
													distracted by the readable content of a page when looking at its
													layout.</p>
												<ul class="list-check-try fw-medium m-b30">
											...
											<div class="item1">
												<div class="info-widget style-5">
													<div class="info-widget-profile">
														<div class="widget-media">
															<img src="images/avatar/middle/avatar1.webp" alt="">
														</div>
														<div class="widget-content">
															<h6 class="title mb-0">Nashid Martines</h6>
															<p class="text mb-0">Cardiac Surgery</p>
														</div>
													</div>
													<a href="service-detail.php"
														class="btn btn-lg btn-square btn-primary rounded-circle">
														<i class="feather icon-arrow-up-right"></i>
													</a>
												</div>
											</div>
							...
							<div class="dz-flex-item swiper-slide">
								<div class="dz-flex-head"
									style="background-image: url(images/services/middle/img2.webp);">
									<a href="service-detail.php"
										class="btn btn-square btn-lg btn-white btn-shadow btn-rounded">
										<i class="feather icon-arrow-up-right"></i>
									</a>
									<h3 class="title">Dermatologic Surgery</h3>
								</div>
								<div class="dz-flex-info">
									<div class="dz-flex-inner">
										<div class="dz-media">
										...
										<div class="dz-info">
											<div class="dz-info-top">
												<h3 class="dz-title">Dermatologic Surgery</h3>
												<p class="text">It is a long established fact that a reader will be
													distracted by the readable content of a page when looking at its
													layout.</p>
												<ul class="list-check-try fw-medium m-b30">
							...
							<div class="dz-flex-item swiper-slide">
								<div class="dz-flex-head"
									style="background-image: url(images/services/middle/img3.webp);">
									<a href="service-detail.php"
										class="btn btn-square btn-lg btn-white btn-shadow btn-rounded">
										<i class="feather icon-arrow-up-right"></i>
									</a>
									<h3 class="title">Earlobe Repair</h3>
								</div>
								<div class="dz-flex-info">
									<div class="dz-flex-inner">
										<div class="dz-media">
										...
										<div class="dz-info">
											<div class="dz-info-top">
												<h3 class="dz-title">Earlobe Repair</h3>
												<p class="text">It is a long established fact that a reader will be
													distracted by the readable content of a page when looking at its
													layout.</p>
												<ul class="list-check-try fw-medium m-b30">
							...
							<div class="dz-flex-item swiper-slide">
								<div class="dz-flex-head"
									style="background-image: url(images/services/middle/img4.webp);">
									<a href="service-detail.php"
										class="btn btn-square btn-lg btn-white btn-shadow btn-rounded">
										<i class="feather icon-arrow-up-right"></i>
									</a>
									<h3 class="title">Laser Resurfacing</h3>
								</div>
								<div class="dz-flex-info">
									<div class="dz-flex-inner">
										<div class="dz-media">
										...
										<div class="dz-info">
											<div class="dz-info-top">
												<h3 class="dz-title">Laser Resurfacing</h3>
												<p class="text">It is a long established fact that a reader will be
													distracted by the readable content of a page when looking at its
													layout.</p>
												<ul class="list-check-try fw-medium m-b30">
							...
							<div class="dz-flex-item swiper-slide">
								<div class="dz-flex-head"
									style="background-image: url(images/services/middle/img5.webp);">
									<a href="service-detail.php"
										class="btn btn-square btn-lg btn-white btn-shadow btn-rounded">
										<i class="feather icon-arrow-up-right"></i>
									</a>
									<h3 class="title">Anti Aging</h3>
								</div>
								<div class="dz-flex-info">
									<div class="dz-flex-inner">
										<div class="dz-media">
										...
										<div class="dz-info">
											<div class="dz-info-top">
												<h3 class="dz-title">Anti Aging</h3>
												<p class="text">It is a long established fact that a reader will be
													distracted by the readable content of a page when looking at its
													layout.</p>
												<ul class="list-check-try fw-medium m-b30">
					...
					<div class="dz-separator style-1">
			...
			<section class="content-inner bg-light bg-bottom-half-white">
				<div class="container">
					<div class="section-head style-3 text-center m-b30 wow fadeInUp" data-wow-delay="0.2s"
						data-wow-duration="0.8s">
						<h2 class="title m-b0">After Treatment</h2>
					</div>
					<div class="row m-b30">
						<div class="col-md-6 m-b15 wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="0.8s">
							<div class="twentytwenty-box twentytwenty-sm shadow">
								<div class="twentytwenty-container">
									<img src="images/compare/before1.webp" alt="">
									<img src="images/compare/after1.webp" alt="">
								</div>
							</div>
						</div>
						<div class="col-md-6 m-b15 wow fadeInUp" data-wow-delay="0.6s" data-wow-duration="0.8s">
							<div class="twentytwenty-box twentytwenty-sm shadow">
								<div class="twentytwenty-container">
									<img src="images/compare/before2.webp" alt="">
									<img src="images/compare/after2.webp" alt="">
								</div>
							</div>
						</div>
					</div>
			...
			<section class="content-inner bg-light">
				<div class="container">
					<div class="section-head style-3 m-b30 text-center wow fadeInUp" data-wow-delay="0.2s"
						data-wow-duration="0.8s">
						<h2 class="title">Our Featured <br> Beauty Treatments</h2>
					...
					<div class="site-filters clearfix style-1 wow fadeInUp" data-wow-delay="0.4s"
						data-wow-duration="0.8s">
						<ul class="filters justify-content-center" data-bs-toggle="buttons">
							<li class="active">
								<input type="radio">
								<a class="btn" href="javascript:void(0);">Skin & Face</a>
							</li>
							<li data-filter=".data-oils">
								<input type="radio">
								<a class="btn" href="javascript:void(0);">Massage Oils</a>
							</li>
							<li data-filter=".data-cosmetics">
								<input type="radio">
								<a class="btn" href="javascript:void(0);">Cosmetics</a>
							</li>
							<li data-filter=".data-offers">
								<input type="radio">
								<a class="btn" href="javascript:void(0);">Daily Offers</a>
							</li>
						</ul>
					</div>
					<div class="clearfix">
						<ul id="masonry" class="row">
							<li class="card-container col-xl-3 col-lg-4 col-sm-6 m-b30 data-oils data-offers wow fadeInUp"
								data-wow-delay="0.2s" data-wow-duration="0.8s">
								<div class="shop-card">
									<div class="dz-media">
										<img src="images/shop/img1.webp" alt="image">
										<div class="shop-meta">
											<a href="javascript:void(0);" class="btn quick-view" data-bs-toggle="modal"
									...
									<div class="dz-content">
										<div class="inner-content">
											<h3 class="title"><a href="shop-details.php">Night beauty</a></h3>
											<span class="price">$89.00 <del>$119.00</del></span>
										</div>
										<a href="shop-details.php"
											class="btn btn-square btn-lg btn-white btn-rounded shop-share-btn">
											<i class="feather icon-arrow-up-right"></i>
										</a>
									</div>
								</div>
							...
							<li class="card-container col-xl-3 col-lg-4 col-sm-6 m-b30 data-cosmetics wow fadeInUp"
								data-wow-delay="0.6s" data-wow-duration="0.8s">
								<div class="shop-card">
									<div class="dz-media">
					...
					<div class="row content-wrapper style-2 align-items-center">
						<div class="col-xxl-7 col-lg-6 m-b30 align-self-center">
							<div class="content-info">
								...
								<div class="accordion dz-accordion style-2 m-b35 wow fadeInUp" data-wow-delay="0.4s"
								...
								<div class="d-flex align-items-center m-b15 wow fadeInUp" data-wow-delay="0.6s"
									data-wow-duration="0.8s">
									...
									<a href="about-us-2.php"
										class="btn btn-square btn-xl btn-white shadow-sm btn-rounded">
										<svg width="24" height="24" viewBox="0 0 24 24" fill="none"
											xmlns="http://www.w3.org/2000/svg">
											<path d="M7 17L17 7" stroke="var(--bs-primary)" stroke-width="1.5"
												stroke-linecap="round" stroke-linejoin="round"></path>
			...
			<section class="content-inner bg-light gradient-bottom-light">
				<div class="container">
					<div class="section-head style-3 text-center wow fadeInUp" data-wow-delay="0.2s"
						data-wow-duration="0.8s">
						<h2 class="title m-b10">We Employ only Specialists</h2>
					...
					<div class="row">
						<div class="col-xl-3 col-sm-6 m-b30 wow fadeInUp" data-wow-delay="0.2s"
							...
							<div class="dz-team style-1 active box-hover">
								<div class="dz-content">
									<h3 class="dz-name"><a href="team-detail.php">Sophia Bennett</a></h3>
									<span class="dz-position">Dermatologist</span>
								</div>
								<div class="dz-media">
									<img src="images/team/img1.webp" alt="/">
									...
									<ul class="dz-social">
										...
										<li>
											<a class="x-twitter" href="https://twitter.com/" target="_blank">
												<i class="fa-brands fa-x-twitter"></i>
											</a>
										</li>
										<li>
						...
						<div class="col-xl-3 col-sm-6 m-b30 wow fadeInUp" data-wow-delay="0.4s"
							...
							<div class="dz-team style-1 box-hover">
								<div class="dz-content">
									<h3 class="dz-name"><a href="team-detail.php">Ethan Clarke</a></h3>
									<span class="dz-position">Cosmetic Dermatology</span>
								</div>
								<div class="dz-media">
									<img src="images/team/img2.webp" alt="/">
									<a href="appointment.php" class="btn btn-primary">
										<i class="feather icon-calendar m-r5"></i>
										Appointment Now
									</a>
						...
						<div class="col-xl-3 col-sm-6 m-b30 wow fadeInUp" data-wow-delay="0.6s"
							...
							<div class="dz-team style-1 box-hover">
								<div class="dz-content">
									<h3 class="dz-name"><a href="team-detail.php">Olivia Harris</a></h3>
									<span class="dz-position">Aesthetic Specialist</span>
								</div>
								<div class="dz-media">
									<img src="images/team/img3.webp" alt="/">
									<a href="appointment.php" class="btn btn-primary">
										<i class="feather icon-calendar m-r5"></i>
										Appointment Now
									</a>
						...
						<div class="col-xl-3 col-sm-6 m-b30 wow fadeInUp" data-wow-delay="0.8s"
							...
							<div class="dz-team style-1 box-hover">
								<div class="dz-content">
									<h3 class="dz-name"><a href="team-detail.php">Isabella Moore</a></h3>
									<span class="dz-position">Skin Rejuvenation</span>
								</div>
								<div class="dz-media">
									<img src="images/team/img4.webp" alt="/">
									<a href="appointment.php" class="btn btn-primary">
										<i class="feather icon-calendar m-r5"></i>
										Appointment Now
									</a>
				...
				<div class="container">
					<div class="row align-items-center pricingtable-content-wrapper">
						<div class="col-xxl-3 col-lg-12 col-md-6 m-b30">
							<div class="section-head style-3 m-b30 row align-items-end wow fadeInUp"
								data-wow-delay="0.2s" data-wow-duration="0.8s">
							...
							<a href="service-detail.php"
								class="btn btn-icon btn-lg btn-primary btn-shadow w-auto wow fadeInUp"
								data-wow-delay="0.4s" data-wow-duration="0.8s">
								View All Services
								<span class="right-icon"><i class="feather icon-arrow-right"></i></span>
							</a>
						</div>
						<div class="col-xxl-4 col-xl-4 col-lg-5 col-md-6 m-b30 wow fadeInUp" data-wow-delay="0.6s"
							data-wow-duration="0.8s">
							<div class="content-bx style-1 bg-primary">
								<h3 class="title"><span>Save More</span>With Good Plans.</h3>
								<p>Choose a plan and get onboard in minutes. Then get $100 credits for your next
									payment.</p>
								<a href="pricing-table.php" class="btn-link"><i
										class="feather icon-arrow-right text-white"></i></a>
								<div class="dz-media">
						...
						<div class="col-xxl-5 col-xl-8 col-lg-7 align-self-stretch m-b30">
							<div class="pricingtable-wrapper style-1 wow fadeInUp" data-wow-delay="0.8s"
								data-wow-duration="0.8s">
								<div class="pricingtable-inner">
									...
									<div class="right-box">
										<div class="clearfix">
											...
											<p class="m-b20">It is a long established fact that a reader will be
												distracted.</p>
										...
										<div class="pricingtable-button mt-auto">
											<a href="pricing-table.php"
												class="btn btn-secondary btn-hover1 w-100 m-t30"><span>Choose</span></a>
										</div>
									</div>
								</div>
							</div>
			...
			<div class="dz-marquee style-2 bg-light">
				<ul class="marquee-list">
					<li class="item text-outline wow bounceIn" data-wow-delay="0.1s" data-wow-duration="0.8s">Bodycare
					</li>
					<li class="item text-outline wow bounceIn" data-wow-delay="0.2s" data-wow-duration="0.8s">
						Accessories</li>
			...
			<section class="content-inner-3 bg-light pb-0 overflow-hidden">
				<div class="container">
					<div class="row content-wrapper style-3 align-items-end justify-content-center">
						<div class="col-xl-6 col-lg-12 order-xl-1 m-b30">
							<div class="content-info">
							...
							<div class="content-media">
								...
								<div class="item1">
									<svg viewBox="0 0 694 694" fill="none" xmlns="http://www.w3.org/2000/svg">
										...
										<ellipse opacity="0.6" cx="525" cy="109.5" rx="4" ry="3.5"
											fill="var(--bs-primary)" />
										<circle cx="642.5" cy="361.5" r="3.5" fill="var(--bs-primary)" />
										<ellipse opacity="0.3" cx="573" cy="606.5" rx="3" ry="2.5"
											fill="var(--bs-primary)" />
									</svg>
								</div>
					...
					<div class="row content-wrapper style-4 align-items-center">
						<div class="col-xl-6 col-lg-5 m-b30">
							<div class="content-info">
								...
								<ul class="list-check-circle-small text-secondary grid-2 m-b35 wow fadeInUp"
									data-wow-delay="0.4s" data-wow-duration="0.8s">
								...
								<div class="d-flex flex-wrap align-items-center wow fadeInUp" data-wow-delay="0.6s"
									data-wow-duration="0.8s">
									<a href="appointment.php"
										class="btn btn-lg btn-icon btn-secondary btn-shadow m-r40 mb-3 mb-xl-0">
										Appointment
										<span class="right-icon"><i class="feather icon-arrow-right"></i></span>
									</a>
									<div class="info-widget style-3">
							...
							<div class="content-media">
								<div class="row justify-content-center">
									<div class="col-sm-6" data-bottom-top="transform: translateY(-50px)"
										data-top-bottom="transform: translateY(50px)">
										<div class="img1">
											<img src="images/about/img6.webp" alt="">
											<div class="video-bx1">
												<svg width="44" height="44" viewBox="0 0 44 44" fill="none"
													xmlns="http://www.w3.org/2000/svg">
													<path d="M37.6232 13.8804L27.0337 21.4443L37.6232 29.0083V13.8804Z"
														stroke="#F46700" stroke-width="2" stroke-linecap="round"
											...
											<div class="call-widget">
												...
												<a href="javascript:void(0);">
													<svg width="25" height="24" viewBox="0 0 25 24" fill="none"
														...
														<path
															...
															fill="white" />
														<ellipse cx="16.5687" cy="10.9599" rx="0.975976" ry="0.975976"
															fill="white" />
														<circle cx="12.6649" cy="10.9599" r="0.975976" fill="white" />
														<ellipse cx="8.76113" cy="10.9599" rx="0.975976" ry="0.975976"
															fill="white" />
													</svg>
												</a>
													...
													<svg width="25" height="24" viewBox="0 0 25 24" fill="none"
														...
														<defs>
															<clipPath id="clip0_601_1526">
																<rect width="23.4234" height="23.4234" fill="white"
												...
												<a href="javascript:void(0);">
													<svg width="24" height="24" viewBox="0 0 24 24" fill="none"
														xmlns="http://www.w3.org/2000/svg">
														<rect x="9.08447" y="3.15186" width="5.85586" height="10.7357"
															rx="2.92793" stroke="white" stroke-linejoin="round" />
														<path
												...
												<svg width="25" height="24" viewBox="0 0 25 24" fill="none"
													xmlns="http://www.w3.org/2000/svg">
													<path d="M21.2756 7.88135L15.563 11.9618L21.2756 16.0423V7.88135Z"
										...
										<div class="widget-rating2">
											...
											<div class="clearfix">
												<div class="d-flex">
													...
													<span class="rating ms-1">(4.8)</span>
												</div>
												<span class="text">12k+ ratings on google</span>
											</div>
										</div>
										<div class="img2">
											<img src="images/about/img7.webp" alt="">
										</div>
									</div>
								</div>
							</div>
				...
				<div thumbsSlider="" class="swiper dzThumbSlider">
					<div class="swiper-wrapper">
						<div class="swiper-slide">
							<img src="images/testimonial/thumbs/pic1.jpg" />
						</div>
						<div class="swiper-slide">
							<img src="images/testimonial/thumbs/pic2.jpg" />
						</div>
						<div class="swiper-slide">
							<img src="images/testimonial/thumbs/pic3.jpg" />
						</div>
						<div class="swiper-slide">
							<img src="images/testimonial/thumbs/pic4.jpg" />
						</div>
						<div class="swiper-slide">
							<img src="images/testimonial/thumbs/pic5.jpg" />
						</div>
						<div class="swiper-slide">
							<img src="images/testimonial/thumbs/pic6.jpg" />
						</div>
						<div class="swiper-slide">
							<img src="images/testimonial/thumbs/pic7.jpg" />
						</div>
						<div class="swiper-slide">
							<img src="images/testimonial/thumbs/pic8.jpg" />
						</div>
						<div class="swiper-slide">
							<img src="images/testimonial/thumbs/pic9.jpg" />
						</div>
						<div class="swiper-slide">
							<img src="images/testimonial/thumbs/pic10.jpg" />
						</div>
					</div>
				</div>
				<div class="container">
					...
					<div class="swiper dzThumbPreview wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="0.8s">
						<div class="swiper-wrapper">
							<div class="swiper-slide">
								<div class="testimonial-1">
										...
										<div class="testimonial-contant">
											<div class="testimonial-text">
												<p>It is a long established fact that a reader will be distracted by the
													...
													using Lorem Ipsum is that it has a making it look like readable
													English.</p>
											</div>
										</div>
									...
									<div class="testimonial-media">
										<img src="images/testimonial/slider/pic1.jpg" alt="">
										<div class="item1">
							...
							<div class="swiper-slide">
								<div class="testimonial-1">
									<div class="testimonial-detail">
										...
										<div class="testimonial-info">
											<div class="clearfix">
												<h5 class="testimonial-name">Sophia Williams</h5>
												<span class="testimonial-position">Postgraduate Student</span>
											</div>
										</div>
									</div>
									<div class="testimonial-media">
										<img src="images/testimonial/slider/pic2.jpg" alt="">
										<div class="item1">
											<div class="info-widget">
												<ul class="star-list">
													<li><i class="fa fa-star"></i></li>
							...
							<div class="swiper-slide">
								<div class="testimonial-1">
									...
									<div class="testimonial-media">
										<img src="images/testimonial/slider/pic3.jpg" alt="">
										<div class="item1">
											<div class="info-widget">
												<ul class="star-list">
													<li><i class="fa fa-star"></i></li>
							...
							<div class="swiper-slide">
								<div class="testimonial-1">
									...
									<div class="testimonial-media">
										<img src="images/testimonial/slider/pic4.jpg" alt="">
										<div class="item1">
											<div class="info-widget">
												<ul class="star-list">
													<li><i class="fa fa-star"></i></li>
							...
							<div class="swiper-slide">
								<div class="testimonial-1">
									...
									<div class="testimonial-media">
										<img src="images/testimonial/slider/pic5.jpg" alt="">
										<div class="item1">
											<div class="info-widget">
												<ul class="star-list">
													<li><i class="fa fa-star"></i></li>
							...
							<div class="swiper-slide">
								<div class="testimonial-1">
									<div class="testimonial-detail">
										...
										<div class="testimonial-info">
											<div class="clearfix">
												<h5 class="testimonial-name">jo Johnson</h5>
												<span class="testimonial-position">Postgraduate Student</span>
											</div>
										</div>
									</div>
									<div class="testimonial-media">
										<img src="images/testimonial/slider/pic6.jpg" alt="">
										<div class="item1">
											<div class="info-widget">
												<ul class="star-list">
													<li><i class="fa fa-star"></i></li>
							...
							<div class="swiper-slide">
								<div class="testimonial-1">
									<div class="testimonial-detail">
										...
										<div class="testimonial-info">
											<div class="clearfix">
												<h5 class="testimonial-name">Daniel Brown</h5>
												<span class="testimonial-position">Postgraduate Student</span>
											</div>
										</div>
									</div>
									<div class="testimonial-media">
										<img src="images/testimonial/slider/pic7.jpg" alt="">
										<div class="item1">
											<div class="info-widget">
												<ul class="star-list">
													<li><i class="fa fa-star"></i></li>
							...
							<div class="swiper-slide">
								<div class="testimonial-1">
									...
									<div class="testimonial-media">
										<img src="images/testimonial/slider/pic8.jpg" alt="">
										<div class="item1">
											<div class="info-widget">
												<ul class="star-list">
													<li><i class="fa fa-star"></i></li>
							...
							<div class="swiper-slide">
								<div class="testimonial-1">
									...
									<div class="testimonial-media">
										<img src="images/testimonial/slider/pic9.jpg" alt="">
										<div class="item1">
											<div class="info-widget">
												<ul class="star-list">
													<li><i class="fa fa-star"></i></li>
							...
							<div class="swiper-slide">
								<div class="testimonial-1">
									...
									<div class="testimonial-media">
										<img src="images/testimonial/slider/pic10.jpg" alt="">
										<div class="item1">
											<div class="info-widget">
												<ul class="star-list">
													<li><i class="fa fa-star"></i></li>
						...
						<div class="testimonial-pagination-swiper w-auto swiper-pagination style-1"></div>
					</div>
				</div>
			</section>
				...
				<div class="container">
					<div class="section-head style-1 m-b30 row align-items-end">
						<div class="col-md-7 wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="0.8s">
							<h2 class="title m-b0">Stay Informed with <br> Our Latest Health Blogs</h2>
						</div>
						<div class="col-md-5 text-sm-end d-md-block d-none wow fadeInUp" data-wow-delay="0.4s"
							data-wow-duration="0.8s">
							<a href="blog-grid.php" class="btn btn-icon btn-primary btn-shadow">
								View All
								<span class="right-icon"><i class="feather icon-arrow-right"></i></span>
							</a>
						</div>
					...
					<div class="row content-wrapper style-5">
						<div class="col-lg-5 m-b30 wow fadeInUp" data-wow-delay="0.6s" data-wow-duration="0.8s">
						...
						<div class="col-lg-7 m-b30 wow fadeInUp" data-wow-delay="0.8s" data-wow-duration="0.8s">
									...
									<div class="swiper-slide">
										<div class="dz-card style-1 blog-half">
											<div class="dz-info">
												...
												<h3 class="dz-title"><a href="blog-details.php">Radiant reflections
														expert dermatology and skin.</a></h3>
												<p>It is a long established fact that a reader will be distracted by the
													readable content.</p>
											</div>
											<div class="dz-media">
									...
									<div class="swiper-slide">
										<div class="dz-card style-1 blog-half">
											<div class="dz-info">
												<div class="dz-meta">
													<ul>
														<li class="post-date">22 May 2024</li>
													</ul>
												</div>
												<h3 class="dz-title"><a href="blog-details.php">Healthy glowing skin
														care routine tips</a></h3>
												<p>It is a long established fact that a reader will be distracted by the
													readable content.</p>
											</div>
											<div class="dz-media">
									...
									<div class="swiper-slide">
										<div class="dz-card style-1 blog-half">
											<div class="dz-info">
												<div class="dz-meta">
													<ul>
														<li class="post-date">06 Sep 2024</li>
													</ul>
												</div>
												<h3 class="dz-title"><a href="blog-details.php">Latest advances in
														cosmetic dermatology</a></h3>
												<p>It is a long established fact that a reader will be distracted by the
													readable content.</p>
											</div>
											<div class="dz-media">
									...
									<div class="swiper-slide">
										<div class="dz-card style-1 blog-half">
											<div class="dz-info">
												...
												<h3 class="dz-title"><a href="blog-details.php">Natural remedies for
														acne prevention.</a></h3>
												<p>It is a long established fact that a reader will be distracted by the
													readable content.</p>
											</div>
											<div class="dz-media">
									...
									<div class="swiper-slide">
										<div class="dz-card style-1 blog-half">
											<div class="dz-info">
												<div class="dz-meta">
													<ul>
														<li class="post-date">16 May 2024</li>
													</ul>
												</div>
												<h3 class="dz-title"><a href="blog-details.php">The importance of
														sunscreen everyday.</a></h3>
												<p>It is a long established fact that a reader will be distracted by the
													readable content.</p>
											</div>
											<div class="dz-media">
			...
			<section class="content-wrapper style-8 bg-light">
				<div class="map-wrapper">
					<iframe
						src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4176.894092633746!2d-0.15502509846427073!3d51.502279254634836!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47d8a00baf21de75%3A0x52963a5addd52a99!2sLondon%2C%20UK!5e0!3m2!1sen!2sin!4v1757506574164!5m2!1sen!2sin"
					...
					<div class="container">
						<div class="content-bx style-5 alert alert-dismissible fade show m-b60 position-absolute bottom-0"
							...
							<div class="content-text m-b20">
								...
								<p class="m-b0">234 Oak Drive, Villagetown, USA</p>
							</div>
							<div class="content-text">
								<h6 class="m-b5">Working Hours: </h6>
								<p class="m-b0">Mon-Thu: 8:00am-5:00pm <br> Fri: 8:00am-1:00pm</p>
							</div>
				...
				<div class="container">
					<div class="row justify-content-end">
						<div class="col-xxl-5 col-xl-6 col-lg-7 col-md-12 wow fadeInUp" data-wow-delay="0.2s"
							data-wow-duration="0.8s">
							<div class="item1">
											...
											<div class="row">
												<div class="col-sm-12 m-b30">
													<div
														...
														<input name="dzName" type="text" class="form-control"
												...
												<div class="col-sm-12 m-b30">
													<div
														...
														<input name="dzPhoneNumber" type="tel"
												...
												<div class="col-sm-6 m-b30">
													<div
														...
														<input name="dzOther[dzDate]" required type="text"
															class="form-control" id="datePickerOnly" placeholder="Date">
													</div>
												</div>
												<div class="col-sm-6 m-b30">
													<div
												...
												<div class="col-sm-6">
													<div class="form-check2 m-b5">
														<input class="form-check-input" type="checkbox" value=""
															id="checkBox1">
														<label class="form-check-label" for="checkBox1">Skin Allergy
															Testing</label>
													</div>
													<div class="form-check2 m-b5">
														<input class="form-check-input" type="checkbox" value=""
															id="checkBox2">
														<label class="form-check-label" for="checkBox2">Laser
															Treatments</label>
													</div>
													<div class="form-check2 m-b5">
														<input class="form-check-input" type="checkbox" value=""
												...
												<div class="col-sm-6 m-b30">
													<div class="form-check2 m-b5">
														<input class="form-check-input" type="checkbox" value=""
															id="checkBox4">
														<label class="form-check-label" for="checkBox4">Plastic
															Surgery</label>
													</div>
													<div class="form-check2 m-b5">
														<input class="form-check-input" type="checkbox" value=""
															id="checkBox5">
														<label class="form-check-label" for="checkBox5">Acne Scar
															Treatment</label>
													</div>
													<div class="form-check2 m-b5">
														<input class="form-check-input" type="checkbox" value=""
				...
				<div class="container">
					<div class="swiper client-swiper">
						<div class="swiper-wrapper">
							...
							<div class="swiper-slide wow bounceIn" data-wow-delay="0.9s" data-wow-duration="0.8s">
								<div class="clients-logo1">
									<img src="images/logo/small/logo3.png" alt="">
								</div>
							</div>
							<div class="swiper-slide wow bounceIn" data-wow-delay="1.0s" data-wow-duration="0.8s">
								<div class="clients-logo1">
									<img src="images/logo/small/logo4.png" alt="">
								</div>
							</div>
							<div class="swiper-slide wow bounceIn" data-wow-delay="1.1s" data-wow-duration="0.8s">
								<div class="clients-logo1">
									<img src="images/logo/small/logo5.png" alt="">
								</div>
							</div>
							<div class="swiper-slide wow bounceIn" data-wow-delay="1.2s" data-wow-duration="0.8s">
								<div class="clients-logo1">
									<img src="images/logo/small/logo6.png" alt="">
								</div>
							</div>
		...
		<!-- Footer -->
		<footer class="site-footer style-1 footer-dark background-blend-luminosity"
				...
				<div class="container">
					<div class="fh-inner">
						<div class="row align-items-center">
							<div class="col-lg-4 col-md-5 text-center text-md-start wow fadeInUp" data-wow-delay="0.2s"
								data-wow-duration="0.8s">
								<div class="footer-logo logo-white">
									<a href="index.php"><img src="images/Komal_care-logo.jpeg" alt=""></a>
								</div>
							</div>
							<div class="col-lg-8 col-md-7 text-center text-md-end wow fadeInUp" data-wow-delay="0.4s"
								data-wow-duration="0.8s">
								<div class="m-b25">
			...
			<div class="footer-top">
				<div class="container">
					<div class="row">
						<div class="col-xl-3 col-lg-6 col-sm-12 wow fadeInUp" data-wow-delay="0.6s"
							data-wow-duration="0.8s">
								...
								<div class="col-xl-3 col-md-3 col-6">
									<div class="widget widget_services">
										...
										<ul class="list-hover1">
											...
											<li><a href="thankyou-skincare-2.php"><span>Latest News</span></a></li>
				...
				<div class="container">
					<div class="fm-inner">
						<div class="row g-3 align-items-center">
							...
							<div class="col-xl-3 col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.8s"
								data-wow-duration="0.8s">
								<div class="icon-bx-wraper style-1">
									<div class="icon-bx bg-primary">
										<span class="icon-cell">
						...
						<div class="row">
							<div class="col-lg-6 col-md-12 text-start">
								<p class="copyright-text">© <span class="current-year">2024</span> <a
										href="https://themeforest.net/user/dexignzone" target="_blank">DexignZone</a>
